...
.option-button { min-height: 160px; padding: 3rem; background:#374151; color:#f0e1c9; border-radius:12px; font-size:2rem; font-weight:700; transition:all 0.3s ease; position:relative; overflow:hidden; margin-bottom:20px;}
