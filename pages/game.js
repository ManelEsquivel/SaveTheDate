...
// *******************************************************************
// ⚠️ IDENTIFICADORES REALES DEL FORMULARIO ⚠️
// *******************************************************************
...
const QuizBodaPage = () => {
    ...
    const handleSubmit = (e) => { 
        ...
        // *** CAMPOS OBLIGATORIOS PARA GOOGLE FORMS ***
        const data = {
            ...
            // 🔥 Campos que Google exige para aceptar el POST
            "fvv": "1",
    ...
    return (
        <>
            ...
            <style jsx>{`
                /* (tus estilos originales, no los repito aquí para ahorrar espacio) */
            `}</style>
        </>
    );
};
