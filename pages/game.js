...
.container {
  ...
  align-items: center;
  min-height: 100vh;
  background: linear-gradient(135deg, #00c6ff, #7dff7d);
...
.button { background: linear-gradient(145deg, #ff9800, #ffc107);
  color: #1f2937;
  border: none;
  border-radius: 50px;
  font-weight: 700;
...
.next-button { background: #e5e7eb; color: #1f2937; border: 1px solid #d1d5db; position:relative; overflow:hidden; }
...
.option-button { background: #e0f7fa; border: 2px solid #ff9800; color: #333; color:#f0e1c9; border-radius:12px; font-size:1.3rem; font-weight:700; transition:all 0.3s ease; position:relative; overflow:hidden; }
.option-button:hover { background: #b2ebf2; color: #333; transform: none; box-shadow: none; }
