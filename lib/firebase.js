...
// Usamos el nombre estándar de GCS/Firebase
...
if (process.env.FIREBASE_PRIVATE_KEY_STRING && !admin.apps.length) {
    ...
    // Reconstrucción de la clave privada (para evitar errores PEM)
    ...
    const app = admin.initializeApp({
        ...
        // 🚨 CORRECCIÓN FINAL: Usamos el nombre canónico que el SDK espera.
    ...
    const firebaseConfig = {
      ...
      storageBucket: CANONICAL_STORAGE_BUCKET, // También para el cliente
